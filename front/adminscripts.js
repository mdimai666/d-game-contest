document.addEventListener("DOMContentLoaded", function () {
    d_init_game_contest_funcs(jQuery)
    d_init_game_contest(jQuery)
});


function d_init_game_contest_funcs($) {

    console.log("d_init_game_contest_funcs");
...
function d_init_game_contest($) {

    if(!$('body').hasClass('toplevel_page_d_game_contest')) return;
    ...
    function submitForm1(callback){
        ...
        wpajax('d_game_contest_save_data', postdata, function (data) {
            console.log(data);
    ...
    $('.update-feed-action .button').click(function(){
        ...
        wpajax('d_game_contest_sync_feed', postdata, function (data) {
            console.log(data);
